...
class EnotsWolley(YellowstoneLikeSequence):
...
binary_enots = EnotsWolley(bl.ker_int, {1: 1, 2: 3}, "binary")
primefact_enots = EnotsWolley(fl.kernel, {1: 1, 2: 2}, "primefact")

binary_enots.gen_tbl((1, settings.TABLE_N))
primefact_enots.gen_tbl((1, settings.TABLE_N))
